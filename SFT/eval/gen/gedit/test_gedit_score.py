...
def process_single_item(item, vie_score, max_retries=10000):
    ...
    save_path_fullset_source_image = (
        f"{save_path}/fullset/{group_name}/{instruction_language}/{key}_SRCIMG.png"
    )
...
if __name__ == "__main__":
    ...
    vie_scores = [
        ...
        for k in args.gpt_keys
    ]
    dataset = load_dataset("stepfun-ai/GEdit-Bench")["train"].remove_columns(
            ...
            with ThreadPoolExecutor(max_workers=args.max_workers) as executor:
                ...
                for i, item in enumerate(group_dataset_list):
                    ...
                    future = executor.submit(
                        process_single_item, item, vie_scores[i % len(vie_scores)]
                    )
