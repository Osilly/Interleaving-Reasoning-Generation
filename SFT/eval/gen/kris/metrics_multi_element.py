...
def evaluate_multi_element_images(model_name, category, image_id, metrics=None):
    ...
    for metric in metrics:
        if metric == "consistency":
            ...
            score, reason = extract_score_and_reason(
                resp, score_key="quality_score", reason_fields=["quality_reasoning"]
            )
...
def process_multi_element_image_eval(
...
def run_multi_element_evaluation(
    models=None, categories=None, metrics=None, max_workers=8
):
    """
