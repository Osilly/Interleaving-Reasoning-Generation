...
kris_benchamrk_type = {
    ...
    "Temporal Prediction": ["temporal_prediction"],
    "Social Science": ["humanities", "practical_knowledge"],
    "Natural Science": [
        "biology",
        "chemistry",
        "geography",
...
meta_categories = {
    ...
    "Conceptual Knowledge": ["Social Science", "Natural Science"],
    "Procedural Knowledge": ["Logical Reasoning", "Instruction Decomposition"],
}
...
def summarize_benchmark_scores_with_normalization(results_dir):
    ...
    """
    type_all_scores = defaultdict(
        lambda: defaultdict(list)
    )  # {category: {score_type: [scores]}}
...
def main():
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        help="Results directory containing subitem folders.",
    )
    args = parser.parse_args()

    results_dir = args.results_dir
    type_result, subitem_result, meta_result, overall_result = (
        summarize_benchmark_scores_with_normalization(results_dir, max_score=5)
    )
    ...
    final_result = {"summary": summary_with_meta, "subitems": subitem_result}
