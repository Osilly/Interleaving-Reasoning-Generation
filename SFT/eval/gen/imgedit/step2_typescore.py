...
def main():
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        help="path to the JSON file containing the scores",
    )
    parser.add_argument(
        "--edit_json",
        type=str,
        required=True,
        help="Path  to the JSON file containing the basic edit information",
    )
    parser.add_argument(
        "--typescore_json",
        type=str,
        required=True,
        help="Path  to the JSON file containing the edit type scores",
    )
