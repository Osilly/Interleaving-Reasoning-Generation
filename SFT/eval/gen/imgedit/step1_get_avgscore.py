...
def main():
    parser = argparse.ArgumentParser(
        description="Calculate the average score for each key and save it as a new JSON file"
    )
    parser.add_argument(
        "--result_json", type=str, required=True, help="Path of result_json json"
    )
    parser.add_argument(
        "--average_score_json",
        type=str,
        required=True,
        help="Path of average_score_json json",
    )
