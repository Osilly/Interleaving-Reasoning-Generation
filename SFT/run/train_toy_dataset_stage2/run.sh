...
model_path='results/train_toy_dataset_stage2/checkpoints/checkpoints/0002000/ema.safetensors' # replace it with the model path
dataset_config_path='data/configs/train_toy_dataset_stage2.yaml'
project_name='train_toy_dataset_stage2'
